  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white-100/50 p-4">
      ...
      <img src="/timer-start.svg" alt="timer" className="absolute top-0 right-0  w-12 h-12" />
        ...
        <div className="flex items-center justify-around mb-4">
          <div className="text-center">
            <img src="/femaleavatar4.svg" alt="Ada" className="w-30 h-30 bg-sky-500 shadow-lg  border-4 border-gold-500 mb-2"/>
          ...
          <div className="text-center">
            <img src="/icalon.svg" alt="Icalon" className=" shadow-lg  rounded-ful mb-2" />
      ...
      <div className='absolute bottom-20 right-20'>
        <SpeakerLoudIcon className=" mt-4 font-extrabold text-black w-10 h-10 flex" />
    </div>
    </div>
  );
};
